...
export function CalendrierMessagerieScreen() {
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      <div>
        <h2 className="font-serif text-2xl">Calendrier &amp; messagerie</h2>
        <p className="text-muted-foreground text-sm mt-1">Tes disponibilités et tes échanges, au même endroit.</p>
      </div>
      <Card>
        <CardHeader><h3 className="font-serif text-base">Prochains rendez-vous</h3></CardHeader>
      ...
      <Card>
        <CardHeader><h3 className="font-serif text-base">Messages récents</h3></CardHeader>
        <CardContent className="flex flex-col gap-3">
          {THREADS.map((t) => (
