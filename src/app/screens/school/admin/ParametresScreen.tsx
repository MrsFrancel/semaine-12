...
export function ParametresScreen() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-md">
      ...
      <Card>
        <CardHeader><h3 className="font-serif text-base">Seuil d'inactivité</h3></CardHeader>
      ...
      <Card>
        <CardHeader><h3 className="font-serif text-base">Domaine mail autorisé</h3></CardHeader>
