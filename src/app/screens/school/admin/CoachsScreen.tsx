...
export function CoachsScreen() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      <div>
        <h2 className="font-serif text-2xl">Coachs</h2>
        <p className="text-muted-foreground text-sm mt-1">Stats agrégées et gestion des accès — l'admin décide qui devient coach.</p>
      </div>

      <Card>
        <CardHeader><h3 className="font-serif text-base">Inviter un coach</h3></CardHeader>
      ...
      <Card>
        <CardHeader><h3 className="font-serif text-base">Coachs actifs</h3></CardHeader>
        <CardContent className="flex flex-col gap-3">
          {COACHES.map((c) => (
