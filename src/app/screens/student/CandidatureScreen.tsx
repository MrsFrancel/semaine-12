...
export function CandidatureScreen({ offer, onBack }: { offer: Offer; onBack: () => void }) {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl">
      ...
      <Card>
        <CardHeader><h3 className="font-serif text-base">CV &amp; lettre de motivation</h3></CardHeader>
      ...
      <Card>
        <CardHeader className="flex-row items-center justify-between">
          <h3 className="font-serif text-base">Statut de ta candidature</h3>
      ...
      {status === 'entretien' && (
        <Card className="border-primary/30">
          <CardHeader><h3 className="font-serif text-base">Préparer l'entretien avec ton coach</h3></CardHeader>
