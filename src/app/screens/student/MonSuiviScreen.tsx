...
export function MonSuiviScreen() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 className="font-serif text-2xl">Mon suivi</h2>
      ...
      <Card>
        <CardHeader><h3 className="font-serif text-base">Mes candidatures</h3></CardHeader>
      ...
      <Card>
        <CardHeader><h3 className="font-serif text-base">Messagerie &amp; rendez-vous</h3></CardHeader>
